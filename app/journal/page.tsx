...
export default function JournalPage() {
    ...
    return (
        <div className="flex justify-center w-full px-2 sm:px-4 relative z-0 overflow-x-hidden">
            <aside className="hidden 2xl:block w-[240px] p-3">
                <AdBanner position="left" />
            </aside>
            <main className="w-full max-w-[1600px] px-2 sm:px-4 min-h-screen relative z-0 overflow-x-hidden">
                <div className="p-4 sm:p-6 flex justify-center">
                    <div className="w-full max-w-[1600px] space-y-4">
                        <section>
                            <div className="flex justify-between items-center flex-wrap gap-2 mb-4">
                                ...
                                <div className="btn-group-trendy flex-shrink-0">
                                    <button
                                        ...
                                        className="btn-trendy-secondary flex items-center gap-2 text-xs sm:text-sm px-3 py-1.5 sm:px-4 sm:py-2">
                                    ...
                                    <button
                                        ...
                                        className="btn-trendy-secondary flex items-center gap-2 text-xs sm:text-sm px-3 py-1.5 sm:px-4 sm:py-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 text-red-600 hover:text-red-700 hover:border-red-300 dark:hover:border-red-500">
                            ...
                            <div className={isMobileView ? "" : "overflow-x-auto rounded-lg"}>
                                {!isMobileView && (
                            ...
                            <div className="flex flex-col sm:flex-row justify-center items-center mt-6 sm:mt-8 gap-4 sm:gap-6 px-1">
                                <div className="flex items-center gap-2 sm:gap-3">
                                    <button
                                        ...
                                        className="btn-pagination px-2 py-1.5 w-[32px] sm:w-[40px] flex items-center justify-center disabled:opacity-30 disabled:hover:scale-100 disabled:cursor-not-allowed"
                                    >
                                        ...
                                        {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`btn-pagination px-2 py-1.5 text-xs sm:text-sm w-[32px] sm:w-[40px] flex items-center justify-center ${
                                ...
                                <div className="flex items-center gap-2 sm:gap-3">
                                    <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 font-medium hidden sm:inline">페이지당</span>
                                    <select
                                        value={itemsPerPage}
                                        onChange={(e) => {
                                        ...
                                        className="px-2 py-1.5 text-xs sm:text-sm w-[68px] sm:w-[80px] bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-200 transition-all duration-200 cursor-pointer appearance-none focus:outline-none focus:ring-2 focus:ring-slate-500/20 text-center"
                                    >
